...
export default function Home() {
  ...
  return (
    <main className="w-screen h-screen flex justify-center items-center overflow-y-hidden relative">
        ...
        <Holes />
        <h3 className="absolute bottom-5 left-5 text-xs text-background-right">made with care by <a className="hover:text-[#BA7E7E] hover:cursor-pointer hover:scale-150" href="https://www.instagram.com/vibbyridge/" target="_blank">vibhor (─‿‿─)</a></h3>
    </main>
  );
}
